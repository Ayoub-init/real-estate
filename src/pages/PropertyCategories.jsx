...
export default function PropertyCategories() {
    ...
    const handleCategoryClick = (category) => {
        ...
        dispatch(setFilters({ type: category }));
        navigate('/search');
    };
        ...
        <main className="flex flex-1 flex-col items-center">
          <div className="layout-content-container flex flex-col w-full max-w-[1200px] px-6 py-8 md:py-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Apartments */}
              <div onClick={() => handleCategoryClick('Apartment')} className="group cursor-pointer flex flex-col bg-white dark:bg-slate-900 rounded-xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-100 dark:border-slate-800" style={{ animation: `fadeIn 0.5s ease-out 0s both` }}>
              ...
              {/* Houses */}
              <div onClick={() => handleCategoryClick('House')} className="group cursor-pointer flex flex-col bg-white dark:bg-slate-900 rounded-xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-100 dark:border-slate-800" style={{ animation: `fadeIn 0.5s ease-out 0.1s both` }}>
                <div className="relative h-60 w-full overflow-hidden">
              ...
              {/* Villas */}
              <div onClick={() => handleCategoryClick('Villa')} className="group cursor-pointer flex flex-col bg-white dark:bg-slate-900 rounded-xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-100 dark:border-slate-800" style={{ animation: `fadeIn 0.5s ease-out 0.2s both` }}>
                <div className="relative h-60 w-full overflow-hidden">
              ...
              {/* Commercial */}
              <div className="group cursor-pointer flex flex-col bg-white dark:bg-slate-900 rounded-xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-100 dark:border-slate-800" style={{ animation: `fadeIn 0.5s ease-out 0.3s both` }}>
                <div className="relative h-60 w-full overflow-hidden">
              ...
              {/* Land */}
              <div className="group cursor-pointer flex flex-col bg-white dark:bg-slate-900 rounded-xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-100 dark:border-slate-800" style={{ animation: `fadeIn 0.5s ease-out 0.4s both` }}>
                <div className="relative h-60 w-full overflow-hidden">
